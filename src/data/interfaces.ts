...
paths:
  /summarize:
    ...
    gatewayLink: {
      ...
      controlPlaneName: 'meridian-ai-prod',
      gatewayInstanceName: 'meridian-ai-prod',
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'doc-summarizer-svc', id: 'ai-svc-001' },
        { type: 'Route', name: 'POST /ai/summarize', id: 'ai-rt-001' },
        { type: 'Plugin', name: 'ai-proxy · openai / gpt-4o', id: 'ai-plg-001' },
        { type: 'Plugin', name: 'ai-prompt-guard', id: 'ai-plg-002' },
      ],
...
paths:
  /kyc/review:
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'kyc-review-svc', id: 'ai-svc-002' },
        { type: 'Route', name: 'POST /ai/kyc/review', id: 'ai-rt-002' },
        { type: 'Plugin', name: 'ai-proxy · anthropic / claude-3-5-sonnet', id: 'ai-plg-003' },
        { type: 'Plugin', name: 'ai-pii-sanitizer', id: 'ai-plg-004' },
      ],
...
paths:
  /fraud/narratives:
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'fraud-narrative-svc', id: 'ai-svc-003' },
        { type: 'Route', name: 'POST /ai/fraud/narrative', id: 'ai-rt-003' },
        { type: 'Plugin', name: 'ai-proxy · openai / gpt-4o', id: 'ai-plg-005' },
        { type: 'Plugin', name: 'ai-rate-limiting-advanced', id: 'ai-plg-006' },
      ],
...
paths:
  ...
  /knowledge/sources:
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'banker-knowledge-svc', id: 'ai-svc-005' },
        { type: 'Route', name: 'POST /ai/knowledge/query', id: 'ai-rt-005' },
        { type: 'Plugin', name: 'ai-proxy · anthropic / claude-3-5-sonnet', id: 'ai-plg-007' },
        { type: 'Plugin', name: 'ai-rag-injector', id: 'ai-plg-008' },
      ],
...
paths:
  /credit/explain:
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'credit-explainer-svc', id: 'ai-svc-006' },
        { type: 'Route', name: 'POST /ai/credit/explain', id: 'ai-rt-006' },
        { type: 'Plugin', name: 'ai-proxy · openai / gpt-4o', id: 'ai-plg-009' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'rm-copilot-mcp-svc', id: 'ai-svc-mcp-001' },
        { type: 'Route', name: 'POST /mcp/rm-copilot', id: 'ai-rt-mcp-001' },
        { type: 'Plugin', name: 'ai-mcp-proxy · passthrough-listener', id: 'ai-plg-mcp-001' },
        { type: 'Plugin', name: 'ai-mcp-oauth2', id: 'ai-plg-mcp-002' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'aml-investigator-mcp-svc', id: 'ai-svc-mcp-002' },
        { type: 'Route', name: 'POST /mcp/aml', id: 'ai-rt-mcp-002' },
        { type: 'Plugin', name: 'ai-mcp-proxy · passthrough-listener', id: 'ai-plg-mcp-003' },
        { type: 'Plugin', name: 'ai-pii-sanitizer', id: 'ai-plg-mcp-004' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      ...
      environment: 'Production',
      objects: [
        { type: 'Service', name: 'mortgage-uw-mcp-svc', id: 'ai-svc-mcp-003' },
        { type: 'Route', name: 'POST /mcp/mortgage-uw', id: 'ai-rt-mcp-003' },
        { type: 'Plugin', name: 'ai-mcp-proxy · passthrough-listener', id: 'ai-plg-mcp-005' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      gatewayProductType: 'ai',
      controlPlaneName: 'meridian-ai-sandbox',
      gatewayInstanceName: 'meridian-ai-sandbox',
      environment: 'Development',
      objects: [
        { type: 'Service', name: 'treasury-liquidity-mcp-svc', id: 'ai-svc-mcp-004' },
        { type: 'Route', name: 'POST /mcp/treasury-liquidity', id: 'ai-rt-mcp-004' },
        { type: 'Plugin', name: 'ai-mcp-proxy · passthrough-listener', id: 'ai-plg-mcp-006' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      ...
      environment: 'Development',
      objects: [
        { type: 'Service', name: 'card-disputes-mcp-svc', id: 'ai-svc-mcp-005' },
        { type: 'Route', name: 'POST /mcp/card-disputes', id: 'ai-rt-mcp-005' },
        { type: 'Plugin', name: 'ai-mcp-proxy · passthrough-listener', id: 'ai-plg-mcp-007' },
      ],
  ...
  "tools": [
    ...
    gatewayLink: {
      ...
      environment: 'Development',
      objects: [
        { type: 'Service', name: 'cc-agent-mcp-svc', id: 'ai-svc-mcp-007' },
        { type: 'Route', name: 'POST /mcp/cc-agent', id: 'ai-rt-mcp-007' },
        { type: 'Plugin', name: 'ai-mcp-proxy · conversion-listener', id: 'ai-plg-mcp-008' },
        { type: 'Plugin', name: 'ai-prompt-guard', id: 'ai-plg-mcp-009' },
      ],
